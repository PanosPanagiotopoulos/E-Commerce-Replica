...
namespace E_Commerce_Application_API.Models
{
    public class Product
    {
        ...
        // The relation between the product and its assigned images for it
        public ICollection<ImageFile> Images { get; set; }
        // The relation between the product and its assigned payment methods for it
        public ICollection<MethodProducts> PaymentMethods { get; set; }
        // The relation between the product and the carts it is assigned to
